angular.module('myApp', [])
    .controller('myCtrl', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
        ...
        function getUserNormWork() {
            $http.get('/Admin/Get_UserNormWork').then(function (response) {
        ...
        function getArea() {
            $http.get('/Admin/GetArea_UnitPrice').then(function (response) {
        ...
        $scope.save_tempWork = function () {
            ...
            if ($scope.flag_validation == 1) {
                ...
                $http({
                    method: "post",
                    url: "/Admin/post_saveUser_NormWork",
                    data: JSON.stringify(data),
                    dataType: "json",
                })
                 .then(function (result) {
                     if (result.data == "ok") {
                         alert("Thêm định mức thành công");
                         location.reload();
                     }
                 });
            }
        ...
        $scope.show_UserNormWork = function (x) {
            ...
            $http({
                method: "GET",
                url: "/Admin/Get_UserNormWorkDetail",
                params: { id: id }
            })
                .then(function (response) {
        ...
        $scope.delete_UserNormWork = function (x) {
            ...
            if (r == true) {
                ...
                $http({
                    method: "post",
                    url: "/Admin/post_deleteUser_NormWork",
                    params: { id: id },
                    dataType: "json",
                })
                    .then(function (result) {
